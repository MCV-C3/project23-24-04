...
def build_mlp(IMG_SIZE, activation='relu'):
  ...
  model.add(Dense(units=2048, activation=activation,name='second'))
  model.add(Dense(units=1024, activation=activation, name='third'))
  model.add(Dense(units=512, activation=activation, name='fourth'))
